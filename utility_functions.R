...
###################################################################
## Run SCType For Integrated Objects
###################################################################
## Main function
...
RunSCTypeInt = function(seu,custom_gene_list=NULL,tissue_type="Immune system",plot=T){
  ...
  set.seed(1)
  es.max = sctype_score(as.matrix(GetAssayData(seu, slot = "integrated$data")), scaled = FALSE,
                        gs = gs_list$gs_positive, gs2 = gs_list$gs_negative)
