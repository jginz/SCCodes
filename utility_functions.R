...
RunSCType <- function(seu,custom_gene_list=NULL,tissue_type="Immune system",plot=T){
  ...
  if(is.null(custom_gene_list)){
    db_ = "data/genesets/Mouse/ScTypeDB_full.xlsx"
...
RunUCell = function(seu, geneset_file = "data/genesets/Mouse/acharya_genesets_mouse.gmt",ncores=2){
